...
std::shared_ptr<VfServerRPCInvoker> VfServerRPCInvoker::create(int entityId)
{
    return std::make_shared<VfServerRPCInvoker>(entityId);
}

VfServerRPCInvoker::VfServerRPCInvoker(int entityId) :
...
QUuid VfServerRPCInvoker::invokeRPC(QString procedureName, QVariantMap paramters)
{
...
void VfServerRPCInvoker::processCommandEvent(VeinEvent::CommandEvent *cmdEvent)
{
...
void VfServerRPCInvoker::processErrorCommandEventData(VeinEvent::EventData *originalEventData)
{
