...
public:
    ...
    virtual void startConnection(const QString &ipAddress, quint16 port) = 0;
    ...
    virtual void writeRaw(const QByteArray &message) const = 0;

    virtual QUuid getPeerId() const  = 0;
    virtual void setPeerId(const QUuid &peerId) = 0;
